  ...
  return (
            ...
            <div className={`side-panel ${isPanelOpen ? 'open' : ''}`}>
                ...
                <div className="side-panel-content">
                    ...
                    <ul>
                        ...
                        <li onClick={() => { navigate('/ContactPage'); togglePanel(); }}>Contact</li>
                        <li onClick={() => { navigate('/faq'); togglePanel(); }}>FAQ</li>
                        <li onClick={() => { navigate('/Aboutpage'); togglePanel(); }}>About</li>
                    </ul>
                </div>
            </div>
     ...
     <div className="mc1 " >
      ...
      backgroundImage: 'url(https://www.carnivaltourskochi.com/uploads/1/2/5/4/12541412/4962850_orig.gif)', 
       backgroundRepeat: "no-repeat",backgroundSize:"cover"
        ...
        <buttom className="BookButton" onClick={()=>navigate('/login')}>Book Now</buttom>
    ...
    <footer className="footer"> 
        <p className="text-footer"> 
            Fix My Weekend Registered & Central Office, No.20 Paris corner, New York-000001.
            <br></br><br></br>
